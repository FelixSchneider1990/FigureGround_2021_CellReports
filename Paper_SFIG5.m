...
ax2                 = subplot(6,4,[3 4 7 8]); hold on
im                  = imagesc(avgLFP(:,idx));
colormap(gray(256));
caxis(ax2,[-100 400])
ax2.YLim            = [1 30];
...
ax3                 = subplot(6,4,[9 10 13 14]); hold on
im                  = imagesc(mat(:,idx));
colormap(gray(256));
caxis(ax3,[0 3])
...
ax4                 = subplot(6,4,[11 12 15 16]); hold on
im                  = imagesc(mat_lfp(:,idx));
colormap(gray(256));
caxis(ax4,[-100 400])
...
export_fig([dest_dir 'SFIG5'], '-r400',f);

set(f,'Units','Inches');
pos = get(f,'Position');
set(f,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(f, [dest_dir 'SFIG5'], '-dpdf', '-r400'); 