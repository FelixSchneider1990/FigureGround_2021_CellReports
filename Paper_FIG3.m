...
len         = [l fliplr(l)];
ci          = [CI(1,:) fliplr(CI(2,:))];
fill(len,ci,col(1,:)*0.7,'EdgeColor','none', 'FaceAlpha', .3); hold on
...
len         = [l fliplr(l)];
ci          = [CI(1,:) fliplr(CI(2,:))];
fill(len,ci,col(2,:)*0.7,'EdgeColor','none', 'FaceAlpha', .3); hold on
...
for iAn = 1:2
    ...
    for iFi = 1:2
        ...
        c = 0; cc = 0; mtar8 = []; mtar12 = []; mctr = []; f8 = []; f12 = []; 
        latency12 = []; latency8 = []; dFG8 = []; dFG12 = []; dCoh = [];
