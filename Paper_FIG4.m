...
inclIdx                     = [IN{1,1} IN{1,2} IN{2,1} IN{2,2}];    % Only sound-responsive units with sign. FG modulation
pval(1)                   	= signrank(allAUCFD_pop(inclIdx),.5);
pval(2)                   	= signrank(allAUCFO_pop(inclIdx),.5);
pval(3)                   	= signrank(allAUCC_pop(inclIdx),.5);
pval(4)                 	= signrank(allAUCCD_pop(inclIdx),.5);
pval(5)                    	= signrank(allAUCHM_pop(inclIdx),.5);
pval(6)                   	= signrank(allAUCHMD_pop(inclIdx),.5);
pval(7)                   	= signrank(allAUCMC_pop(inclIdx),.5);
pval(8)                    	= signrank(allAUCMCD_pop(inclIdx),.5);

pval(9)                    	= signrank(allAUCFD_pop(~inclIdx),.5);
pval(10)                 	= signrank(allAUCFO_pop(~inclIdx),.5);
pval(11)                    = signrank(allAUCC_pop(~inclIdx),.5);
pval(12)                   	= signrank(allAUCCD_pop(~inclIdx),.5);
pval(13)                  	= signrank(allAUCHM_pop(~inclIdx),.5);
pval(14)                   	= signrank(allAUCHMD_pop(~inclIdx),.5);
pval(15)                 	= signrank(allAUCMC_pop(~inclIdx),.5);
pval(16)                   	= signrank(allAUCMCD_pop(~inclIdx),.5);
...
print(f, [dest_dir 'FIG4'], '-dpdf', '-r400'); 
...
pos = get(f,'Position');
set(f,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(f, [dest_dir 'SFIG4'], '-dpdf', '-r400'); 
...
pos = get(f,'Position');
set(f,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(f, [dest_dir 'SFIG4x'], '-dpdf', '-r400'); 
